...
async function fetchWallets() {
  ...
  try {
    ...
    console.error('[Solana] Error fetching wallets:', error);
...
async function handleGenerateWallet() {
  ...
  try {
    ...
    if (response.success) {
      window.$message?.success('Solana wallet generated successfully!');
      await fetchWallets();
    } else {
      throw new Error(response.message || 'Failed to generate wallet');
    }
  } catch (error) {
    console.error('[Solana] Error generating wallet:', error);
...
<template>
  <div class="cardano-network-page">
      ...
      <div class="header-content">
        ...
        <div class="title-section">
          ...
          <div>
            ...
            <p class="subtitle">Manage your SOL wallets and addresses</p>
          </div>
        </div>
    ...
    <!-- Wallets List -->
    <n-card title="💼 Your Solana Wallets" style="margin-top: 24px;">
      ...
      <div v-else-if="wallets.length === 0" style="text-align: center; padding: 40px;">
        ...
        <h3 style="margin-top: 16px;">No Solana Wallets Yet</h3>
        ...
        >
          ...
          <div class="wallet-info">
            ...
            <div class="info-row">
              ...
              <span class="info-value">{{ wallet.balance || '0' }} SOL</span>
            </div>
          ...
          <div class="wallet-actions">
            <n-button size="small" type="primary" ghost @click="window.open(`https://explorer.solana.com/address/${wallet.address}`, '_blank')">
      ...
      <div v-if="selectedWallet" class="wallet-details">
        <n-descriptions :column="1" bordered size="small">
          ...
          <n-descriptions-item label="Network">
            Solana ({{ selectedWallet.networkSymbol }})
          </n-descriptions-item>
        ...
        <div style="display: flex; gap: 12px;">
          <n-button type="primary" block @click="window.open(`https://explorer.solana.com/address/${selectedWallet.address}`, '_blank')">
            🔍 View on Solana Explorer
          </n-button>
        </div>
      </div>
