<template>
  <div class="optimism-network-page">
        <!-- Back Button -->
...
<n-card class="api-selector-card" style="margin-bottom: 20px;">
      <template #header>
        <div style="display: flex; align-items: center; gap: 12px;">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#FF0420" stroke-width="2">
    ...
    <n-card class="scanner-card">
      <n-tabs type="line" animated>
        <n-tab-pane name="wallet" tab="💼 My Wallet">
          <OptimismNetworkScanner :walletAddress="selectedWalletAddress" />
        </n-tab-pane>
      </n-tabs>
    </n-card>
  </div>
...
<style scoped>
.optimism-network-page { padding: 20px; max-width: 1400px; margin: 0 auto; }
