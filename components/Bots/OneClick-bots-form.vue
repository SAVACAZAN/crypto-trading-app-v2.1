...
async function createGridBot() {
  ...
  if (!selectedApiKey.value) {
    ...
    alert('Please select an API key before creating bots');
    return;
  }
...
<n-button size="tiny" class="btn btn-lower" @click="() => updateLowerPriceForAll(0.1)">Lower Price (-10%)</n-button>
<n-button size="tiny" class="btn btn-lower" @click="() => updateLowerPriceForAll(0.2)">Lower Price (-20%)</n-button>
<n-button size="tiny" class="btn btn-lower" @click="() => updateLowerPriceForAll(0.3)">Lower Price (-30%)</n-button>
<n-button size="tiny" class="btn btn-lower" @click="() => updateLowerPriceForAll(0.4)">Lower Price (-40%)</n-button>
</td>
<td>
<!-- Upper Price Buttons -->
...
<n-button size="tiny" class="btn btn-upper" @click="() => updateUpperPriceForAll(0.1)">Upper Price (+10%)</n-button>
<n-button size="tiny" class="btn btn-upper" @click="() => updateUpperPriceForAll(0.2)">Upper Price (+20%)</n-button>
<n-button size="tiny" class="btn btn-upper" @click="() => updateUpperPriceForAll(0.3)">Upper Price (+30%)</n-button>
<n-button size="tiny" class="btn btn-upper" @click="() => updateUpperPriceForAll(0.4)">Upper Price (+40%)</n-button>
</td>
            </td>
