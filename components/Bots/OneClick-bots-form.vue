    ...
    <div class="ticker-bar" v-if="marketForms.length > 0">
      <div class="ticker-content">
        ...
        <div class="ticker-actions">
          ...
          <!-- Lower Price (Short) buttons -->
          <n-button size="tiny" @click="() => updateLowerPriceForAll(0.01)">-1%</n-button>
          <n-button size="tiny" @click="() => updateLowerPriceForAll(0.02)">-2%</n-button>
          <n-button size="tiny" @click="() => updateLowerPriceForAll(0.1)">-10%</n-button>
          <n-button size="tiny" @click="() => updateLowerPriceForAll(0.2)">-20%</n-button>
          <n-button size="tiny" @click="() => updateLowerPriceForAll(0.5)">-50%</n-button>
          <n-button size="tiny" @click="() => updateLowerPriceForAll(0.97)">-97%</n-button>
          <n-button size="tiny" @click="() => updateLowerPriceForAll(0.98)">-98%</n-button>
          <span class="action-separator">|</span>
          <!-- Upper Price (Long) buttons with leverage display -->
          ...
          <span class="action-separator">|</span>
          <!-- Amount fixed values -->
          <n-button size="tiny" @click="() => setAmount(1)">A:1</n-button>
          <n-button size="tiny" @click="() => setAmount(5)">A:5</n-button>
          <n-button size="tiny" @click="() => setAmount(10)">A:10</n-button>
          <n-button size="tiny" @click="() => setAmount(50)">A:50</n-button>
          <n-button size="tiny" @click="() => setAmount(100)">A:100</n-button>
          <span class="action-separator">|</span>
          <!-- Grids fixed values -->
          <n-button size="tiny" @click="() => setNrOfGrids(5)">G:5</n-button>
          <n-button size="tiny" @click="() => setNrOfGrids(10)">G:10</n-button>
          <n-button size="tiny" @click="() => setNrOfGrids(20)">G:20</n-button>
          <n-button size="tiny" @click="() => setNrOfGrids(50)">G:50</n-button>
          <n-button size="tiny" @click="() => setNrOfGrids(100)">G:100</n-button>
        </div>
      </div>
    </div>
    ...
    <div class="content-wrapper" v-if="marketForms.length > 0">
      ...
      <div class="sidebar-config">
        <div class="config-section">
          <div class="section-title collapsible" @click="showConfigDetails = !showConfigDetails">
            ⚙️ Config <span style="float: right;">{{ showConfigDetails ? '▼' : '▶' }}</span>
          </div>
          <div v-show="showConfigDetails" class="config-grid">
            <label>Inc % Buy</label>
          ...
          <n-button v-show="showConfigDetails" type="primary" size="tiny" block @click="saveConfiguration" style="margin-top: 8px;">💾 Save</n-button>
        </div>
