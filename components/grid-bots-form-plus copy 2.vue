...
.form-header td:nth-of-type(3) {
  max-width: 60px !important;
  width: 40px !important;
  padding: 0 !important;
}

.form-header td:nth-of-type(3) :deep(.n-input) {
  width: 60px !important;
}

.form-header td:nth-of-type(3) :deep(.n-input__input-el) {
  font-size: 11px !important;
...
.form-header td:nth-of-type(3) :deep(.n-input__placeholder) {
  font-size: 9px !important;
}

/* Header AMOUNT input - 5th field-cell (amount) - larger */
.form-header td:nth-of-type(4) {
  max-width: 100px !important;
  width: 100px !important;
  padding: 0 !important;
}

.form-header td:nth-of-type(4) :deep(.n-input) {
  width: 150px !important;
}

.form-header td:nth-of-type(4) :deep(.n-input__input-el) {
  font-size: 11px !important;
...
.form-header td:nth-of-type(4) :deep(.n-input__placeholder) {
  font-size: 10px !important;
}

.form-header td:nth-of-type(4) :deep(.n-input__suffix) {
  font-size: 10px !important;
}

/* Header LOWER PRICE - Green - Simple */
