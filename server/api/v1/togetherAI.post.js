...
export default defineEventHandler(async (event) => {
  try {
    ...
    const togetherApiKey = user.aiApiKeys?.together;
    if (!togetherApiKey) return { success: false, error: 'Together AI API key not configured. Please add your API key in the Profile page.' };
