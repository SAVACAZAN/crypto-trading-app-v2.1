...
export default defineEventHandler(async (event) => {
  try {
    ...
    const hfApiKey = user.aiApiKeys?.huggingface;
    if (!hfApiKey) return { success: false, error: 'HuggingFace API key not configured. Please add your API key in the Profile page.' };
